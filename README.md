...
|-----|--------------------|-------------|----------------|----------|----------|
|p.428 |解答をつくっていくなかのgrepのオプション（4箇所）|grep -zoP|grep -zoE|[issue52](https://github.com/shellgei/shellgei160/issues/52)|「念のため」なので-Pはなくてよいのですが、この場合（それからPCREのバージョン等々で変わるかもしれませんが）は行またぎの検索ができないようです。一方、練習3.2.aでは-zPで行またぎの検索ができており、なにか分かる人いたら情報提供おねがいいたします。|
